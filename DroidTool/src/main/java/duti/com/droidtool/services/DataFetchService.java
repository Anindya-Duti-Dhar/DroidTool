...
public class DataFetchService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent != null) {
            ...
            shouldStore = intent.getBooleanExtra(mShouldStore, false);
            hasPaging = intent.getBooleanExtra(mHasPaging, false);
            object = (Object) intent.getSerializableExtra(mObject);
        }
        ...
        if (hasPaging) apiMaster.fetchApiCall(dt.pref.getString(mBaseUrl), tableName, object);
        else apiMaster.post(dt.pref.getString(mBaseUrl), tableName, object, shouldStore);
    ...
    public void stopService(String tableName, String itemName, final boolean isSuccess, final String message) {
    ...
    private void sendBroadCast(String tableName, String itemName, final boolean isSuccess, final String message) {
        Intent broadCastIntent = new Intent("FetchData");
    ...
    private Notification createNotification(String itemName, PendingIntent intent) {
        return new Notification.Builder(this)
                ...
                .setContentText(itemName + " " + this.getString(R.string.fetch_fetching_text))
