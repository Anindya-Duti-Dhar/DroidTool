package duti.com.droidtool.config;
...
public class Constants {
    ...
    public static final String mDatabaseName = "DatabaseName";
    public static final String mDatabaseVersion = "DatabaseVersion";
    public static final String mBaseUrl = "BaseUrl";
