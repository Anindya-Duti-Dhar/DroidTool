...
public class DateTimeManager {
    ...
    public EditText yearPicker(final int resId, final String pickedYear, int hintRes){
        // init EditText
        ...
        etDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // call picker
                showYearDialog(etDate, pickedYear);
            }
        });
        return etDate;
    }

    public void showYearDialog(final EditText etDate, String pickedYear)
    {
...
/*        set.setOnClickListener(new View.OnClickListener()
    ...
    public String getMinLmpDate(String today){
        ...
        if(!TextUtils.isEmpty(today)){
            SimpleDateFormat format = null;
            if(today.matches(".*[a-zA-Z]+.*")) format = new SimpleDateFormat("dd-MMM-yyyy");
            else format = new SimpleDateFormat("yyyy-MM-dd");
            Date date = null;
            try {
